...
namespace NWH.VehiclePhysics2.Modules.FlipOver
{
    ...
    public partial class FlipOverModule : VehicleComponent
    {
        ...
        private IEnumerator FlipOverGraduallyCoroutine()
        {
            ...
            float initialDrag = vehicleController.vehicleRigidbody.drag;
            float initialAngularDrag = vehicleController.vehicleRigidbody.angularDrag;
            vehicleController.vehicleRigidbody.drag = 30f;
            vehicleController.vehicleRigidbody.angularDrag = 30f;
            ...
            while (timer < 1f)
            {
                vehicleController.vehicleRigidbody.drag = Mathf.Lerp(30f, initialDrag, timer);
                vehicleController.vehicleRigidbody.angularDrag = Mathf.Lerp(30f, initialAngularDrag, timer);
            ...
            vehicleController.vehicleRigidbody.drag = initialDrag;
            _flipOverInProgress = false;
