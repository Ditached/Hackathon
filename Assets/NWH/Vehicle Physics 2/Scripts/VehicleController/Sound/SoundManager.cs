...
namespace NWH.VehiclePhysics2.Sound
{
    ...
    public partial class SoundManager : ManagerVehicleComponent
    {
        ...
        public override bool VC_Enable(bool calledByParent)
        {
            ...
            {
                vehicleController.onCameraEnterVehicle.AddListener(ApplyInsideVehicleMixerSettings);
                vehicleController.onCameraExitVehicle.AddListener(ApplyOutsideVehicleMixerSettings);
                vehicleController.onDisable.AddListener(ApplyOutsideVehicleMixerSettings);
                return true;
            }
        ...
        public override bool VC_Disable(bool calledByParent)
        {
            ...
            {
                vehicleController.onCameraEnterVehicle.RemoveListener(ApplyInsideVehicleMixerSettings);
                vehicleController.onCameraExitVehicle.RemoveListener(ApplyOutsideVehicleMixerSettings);
                vehicleController.onDisable.RemoveListener(ApplyOutsideVehicleMixerSettings);
                return true;
            }
        ...
        protected override void VC_Initialize()
        {
            ...
            CreateSourceGO("CrashAudioSources", vehicleController.transform.position, vehicleController.transform, ref crashSourceGO);
            ...
            CreateSourceGO("ExhaustAudioSources", vehicleController.exhaustPosition, vehicleController.transform, ref exhaustSourceGO);
            CreateSourceGO("OtherAudioSources", new Vector3(0, 0.2f, 0), vehicleController.transform, ref otherSourceGO);
            ...
            if (mixer != null)
            {
                masterGroup = mixer.FindMatchingGroups("Master").FirstOrDefault();
                engineMixerGroup = mixer.FindMatchingGroups("Engine").FirstOrDefault();
                transmissionMixerGroup = mixer.FindMatchingGroups("Transmission").FirstOrDefault();
                surfaceNoiseMixerGroup = mixer.FindMatchingGroups("SurfaceNoise").FirstOrDefault();
                otherMixerGroup = mixer.FindMatchingGroups("Other").FirstOrDefault();
        ...
        public override bool OnNUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            switch (index)
            {
                case 0:
                    ...
                    drawer.Property("engineStartStopComponent");
